...
import { loginsuccess, startlogin, loginfail } from "@/redux/Slices/UserSlice";
...
const SignIn = ({currentUser}) => {
    ...
    const SignInWithGoogle = async () => {
        try {
            ...
            const resp = await Axios.post("http://localhost:8080/api/auth/oAuth", data)
                ...
                <div className={style.form_container}>
                    ...
                    <div className={style.form_parent}>
                        ...
                        <form className={style.form} onSubmit={handleForm}>
                            <h1 className={style.input_title}>Sign in</h1>
                            ...
                            <div className={style.form_input}>
                                ...
                                <input type="email" className={style.input_field} value={email} onChange={e => setEmail(e.target.value)} />
                            </div>
                            ...
                            <div className={style.form_input}>
                                ...
                                <input type="password" className={style.input_field} value={password} onChange={e => setPassword(e.target.value)} />
                            </div>
                            
                            <button disabled={isLoading && true} type="submit" className={style.form_input_btn}>Log In to my account</button>
                            <p className="text-gray-400">Don't you have an account ? <Link className="text-blue-700 font-bold" href="/auth/sign-up">Sign Up</Link></p>
